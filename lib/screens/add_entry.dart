...
class AddEntryScreen extends StatefulWidget {
  const AddEntryScreen({super.key, required this.onAddEntry});
                    ...
                    onPressed: () {
                      ...
                      switch (_selectedType) {
                        case 'Book':
                          ...
                          widget.onAddEntry('Book', newEntry);
                          break;
                        case 'Movie':
                          newEntry = Movie(
                            title: titleController.text,
                          ...
                          widget.onAddEntry('Movie', newEntry);
                          break;
                        case 'Game':
                          newEntry = Game(
                            title: titleController.text,
                          ...
                          widget.onAddEntry('Game', newEntry);
                          break;
                        case 'Show':
                          newEntry = Show(
                            title: titleController.text,
                          ...
                          widget.onAddEntry('Show', newEntry);
